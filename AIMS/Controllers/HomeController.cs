 ...
 public IActionResult AssetDetailsComponent(string category)
{
    ...
    var tableData = new List<Dictionary<string, string>> {
         new() { {"Asset Name", "Lenovo ThinkPad E16"}, {"Type", "Laptop"}, {"Tag #", "LT-0020"}, {"Status", "Assigned"} },
            ...
            new() { {"Asset Name", "HP EliteBook 840 G7"}, {"Type", "Laptop"}, {"Tag #", "DT-0011"}, {"Status", "Marked for Survey"} },
            ...
            new() { {"Asset Name", "Apple MacBook Pro 14\""}, {"Type", "Laptop"}, {"Tag #", "LT-1048"}, {"Status", "Marked for Survey"} },
            ...
            new() { {"Asset Name", "Asus ZenBook 14"}, {"Type", "Laptop"}, {"Tag #", "LT-1082"}, {"Status", "Marked for Survey"} },
            ...
            new() { {"Asset Name", "Logitech Zone Wired"}, {"Type", "Headset"}, {"Tag #", "HS-2004"}, {"Status", "Marked for Survey"} },
            ...
            new() { {"Asset Name", "Sony WH-CH710N"}, {"Type", "Headset"}, {"Tag #", "HS-2008"}, {"Status", "Marked for Survey"} },
            ...
            new() { {"Asset Name", "Asus ProArt Display"}, {"Type", "Monitor"}, {"Tag #", "MN-4004"}, {"Status", "Mark for Survey"} },
            new() { {"Asset Name", "LG 27UN850-W 4K"}, {"Type", "Monitor"}, {"Tag #", "MN-4005"}, {"Status", "Available"} },
            new() { {"Asset Name", "ViewSonic VG2455"}, {"Type", "Monitor"}, {"Tag #", "MN-4006"}, {"Status", "Marked for Survey"} },
            ...
            new() { {"Asset Name", "Apple iMac M1 2021"}, {"Type", "Desktop"}, {"Tag #", "DT-5003"}, {"Status", "Marked for Survey"} },
            ...
            new() { {"Asset Name", "Apple Mac Studio"}, {"Type", "Desktop"}, {"Tag #", "DT-5008"}, {"Status", "Marked for Survey"} },
            ...
            new() { {"Asset Name", "Belkin BOOST↑CHARGE USB-C"}, {"Type", "Charging Cable"}, {"Tag #", "CC-6004"}, {"Status", "Marked for Survey"} },
            ...
            new() { {"Asset Name", "Native Union Belt Cable"}, {"Type", "Charging Cable"}, {"Tag #", "CC-6008"}, {"Status", "Marked for Survey"} },

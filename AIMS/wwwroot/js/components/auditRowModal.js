...
(() => {
    ...
    function openRowModalFromTR(tr) {
        ...
        const newEl = $("#ar-new");
        const descEl = /** @type {HTMLTextAreaElement|null} */ ($("#ar-desc"));
        ...
        // Configure Preview Agreement button
        const previewBtn = /** @type {HTMLButtonElement|null} */ ($("#auditPreviewBtn"));
        if (previewBtn) {
            const url = tr.dataset.previewUrl || "";
            previewBtn.dataset.previewUrl = url;
            previewBtn.disabled = !url;
            // If you ever want to hide it instead:
            previewBtn.classList.toggle("d-none", !url);
        }
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const previewBtn = /** @type {HTMLButtonElement|null} */ (document.getElementById("auditPreviewBtn"));
        if (previewBtn) {
